...
INSERT INTO news_relations (news_id, target_type, target_id, target_name)
SELECT 1, 'MOVIE', 1, '星际穿越'
WHERE NOT EXISTS (SELECT 1 FROM news_relations WHERE news_id = 1 AND target_type = 'MOVIE' AND target_id = 1);
